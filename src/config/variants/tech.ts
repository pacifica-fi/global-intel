// Tech/AI variant - app.pacifica.fi
...
export const FEEDS: Record<string, Feed[]> = {
  ...
  security: [
    ...
    { name: 'CISA Advisories', url: 'https://app.pacifica.fi/api/rss-proxy?url=' + encodeURIComponent('https://www.cisa.gov/cybersecurity-advisories/all.xml') },
