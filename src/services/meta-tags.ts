// Dynamic Meta Tags Service for Global Intel
...
export function resetMetaTags(): void {
  const defaultTitle = 'Global Intel - Global Situation with AI Insights';
...
function generateDescription(
  ...
  return `Global Intel ${parts.join('. ')}. Free, open-source geopolitical intelligence.`;
}
